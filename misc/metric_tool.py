...
# 计算kappa系数
def cohen_kappa_score(confusion_matrix, weights=None):
    ...
    Parameters
    ----------
    confusion_matrix : array of shape (n_class,n_class)
    ...
    kappa : float
        ...
        value means complete agreement; zero or lower means chance agreeme
    """
